...
camera_options = [
    ...
    ("৮৫ মিমি লেন্সের সাথে ক্যাপচার (Captured with a 85mm lens)", "Captured with a 85mm lens"),
    ("ওয়াইড-অ্যাঙ্গেল লেন্স দিয়ে ক্যাপচার (Captured with a wide-angle lens)", "Captured with a wide-angle lens"),
    ("আলট্রা-ওয়াইড লেন্স দিয়ে ক্যাপচার (Captured with an ultra-wide lens)", "Captured with an ultra-wide lens"),
    ("টেলিফটো লেন্স দিয়ে ক্যাপচার (Captured with a telephoto lens)", "Captured with a telephoto lens"),
    ("সুপার-টেলিফটো লেন্স দিয়ে ক্যাপচার (Captured with a super-telephoto lens)", "Captured with a super-telephoto lens"),
    ("ম্যাক্রো লেন্স দিয়ে ক্যাপচার (Captured with a macro lens)", "Captured with a macro lens"),
    ("ফিশআই লেন্স দিয়ে ক্যাপচার (Captured with a fisheye lens)", "Captured with a fisheye lens"),
    ("টিল্ট-শিফট লেন্স দিয়ে ক্যাপচার (Captured with a tilt-shift lens)", "Captured with a tilt-shift lens"),
    ("অ্যানামর্ফিক লেন্স দিয়ে ক্যাপচার (Captured with an anamorphic lens)", "Captured with an anamorphic lens"),
    ("ড্রোন ক্যামেরার লেন্স দিয়ে ক্যাপচার (Captured with a drone camera lens)", "Captured with a drone camera lens"),
    ("অ্যাকশন ক্যামেরার লেন্স দিয়ে ক্যাপচার (Captured with an action camera lens)", "Captured with an action camera lens"),
    ("ইনফ্রারেড লেন্স দিয়ে ক্যাপচার (Captured with an infrared lens)", "Captured with an infrared lens"),
    ("সিনেমাটিক লেন্স দিয়ে ক্যাপচার (Captured with a cine lens)", "Captured with a cine lens"),
    ("মিরর লেন্স দিয়ে ক্যাপচার (Captured with a mirror lens)", "Captured with a mirror lens"),
    ("সফট ফোকাস লেন্স দিয়ে ক্যাপচার (Captured with a soft focus lens)", "Captured with a soft focus lens"),
    ("পিনহোল লেন্স দিয়ে ক্যাপচার (Captured with a pinhole lens)", "Captured with a pinhole lens"),
    ("জুম লেন্স দিয়ে ক্যাপচার (Captured with a zoom lens)", "Captured with a zoom lens"),
    ("প্রাইম লেন্স দিয়ে ক্যাপচার (Captured with a prime lens)", "Captured with a prime lens"),
    ("অ্যাস্ট্রোফটোগ্রাফি লেন্স দিয়ে ক্যাপচার (Captured with an astrophotography lens)", "Captured with an astrophotography lens"),
    ("৩৬০° লেন্স দিয়ে ক্যাপচার (Captured with a 360° lens)", "Captured with a 360° lens"),
    ("পেরিস্কোপ টেলিফটো লেন্স দিয়ে ক্যাপচার (Captured with a periscope telephoto lens)", "Captured with a periscope telephoto lens")
